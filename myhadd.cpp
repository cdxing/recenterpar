...
int myhadd(TString WorkPath,Int_t TESTMODE=0,TString DestinationDir="Hist",const Int_t Nfilesperjob=30,TString options="")
{
  //bool	TESTMODE	= true;	// 
  //*******************************************************************
  ...
  TString ListFileName_random = "myhadd_random.list";
  CMD = Form("find %s -maxdepth 1 -size +12k -name \"*.root\" > %s",WorkPath.Data(),ListFileName.Data());gSystem->Exec(CMD.Data());
